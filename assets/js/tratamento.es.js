// ===== Encanto Glow — página de detalle del tratamiento (ES) =====
(function () {
    ...
    root.innerHTML = `
      <section class="tmt-hero">
        <div class="container tmt-hero-inner">
          <span class="eyebrow">Tratamiento no encontrado</span>
          <h1>Ups, esta página no existe</h1>
          <p>El tratamiento que buscas no fue encontrado. Consulta la lista completa de tratamientos de Encanto Glow.</p>
          <a href="index.html#servicios" class="btn btn-primary">Ver todos los tratamientos</a>
        </div>
      </section>`;
    document.title = "Tratamiento no encontrado — Encanto Glow";
    return;
  }

  document.title = treatment.name + " en Sorocaba, Brasil — Encanto Glow | Dra. Laureen Polidoro";

  const seoBase = "https://encantoglow.com.br";
  [
    { rel: "canonical", href: `${seoBase}/es/tratamento.html?t=${slug}` },
  ...
  if (metaDesc) metaDesc.setAttribute("content", treatment.short + " Clínica de estética en Sorocaba, Brasil, con la Dra. Laureen Polidoro.");
    ...
    <section class="tmt-gallery">
      <div class="container">
        <div class="section-head reveal">
          ...
          <h2>Registros del consultorio</h2>
        </div>
  ...
  root.innerHTML = `
    <section class="tmt-hero">
      <div class="container tmt-hero-inner reveal">
        ...
        <span class="eyebrow">Encanto Glow &middot; Tratamientos</span>
        <h1>${treatment.name}</h1>
        <p>${treatment.short}</p>
        <a href="index.html#contacto" class="btn btn-primary">Agendar evaluación</a>
      </div>
    </section>
