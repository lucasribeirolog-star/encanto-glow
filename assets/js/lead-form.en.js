// ===== Encanto Glow — registration form (client area) — EN =====
(function () {
  ...
  if (procedureSelect && typeof TREATMENTS !== "undefined") {
    ...
    outroOpt.value = "Other / not sure yet";
    outroOpt.textContent = "Other / not sure yet";
  ...
  form.addEventListener("submit", async (e) => {
    ...
    if (feedback) {
      ...
      if (result && result.ok) {
        feedback.textContent = "Your information was sent successfully! We'll be in touch soon.";
      } else {
        feedback.textContent = "We couldn't send it right now. Please try again shortly.";
      }
    }
