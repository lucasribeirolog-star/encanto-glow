// ===== Encanto Glow — treatment detail page (EN) =====
(function () {
    ...
    root.innerHTML = `
      <section class="tmt-hero">
        <div class="container tmt-hero-inner">
          <span class="eyebrow">Treatment not found</span>
          <h1>Oops, this page doesn't exist</h1>
          <p>The treatment you're looking for wasn't found. See the full list of Encanto Glow treatments.</p>
          <a href="index.html#services" class="btn btn-primary">See all treatments</a>
        </div>
      </section>`;
    document.title = "Treatment not found — Encanto Glow";
    return;
  }
  ...
  [
    { rel: "canonical", href: `${seoBase}/en/tratamento.html?t=${slug}` },
  ...
  root.innerHTML = `
    <section class="tmt-hero">
      <div class="container tmt-hero-inner reveal">
        <a href="index.html#services" class="tmt-back">&larr; All treatments</a>
        <div class="tmt-icon">${treatment.icon}</div>
        <span class="eyebrow">Encanto Glow &middot; Treatments</span>
        <h1>${treatment.name}</h1>
        <p>${treatment.short}</p>
        <a href="index.html#contact" class="btn btn-primary">Book a consultation</a>
      </div>
    </section>
