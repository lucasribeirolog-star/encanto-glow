...
const FALLBACK_RESULTS = [
  { imagemUrl: '/assets/images/post4.webp', tag: 'Before / After', legenda: 'Facial harmonization' },
  { imagemUrl: '/assets/images/post3.jpg', tag: 'Before / After', legenda: 'Amazing result' },
  { imagemUrl: '/assets/images/reel3.jpg', tag: 'Before / After', legenda: 'Real transformation' },
  { imagemUrl: '/assets/images/post9.jpg', tag: 'Before / After', legenda: 'Lip filler' },
  { imagemUrl: '/assets/images/post1.jpg', tag: 'Before / After', legenda: 'Lip filler' },
  { imagemUrl: '/assets/images/new1.jpg', tag: 'Before / After', legenda: 'Botox — forehead' },
  { imagemUrl: '/assets/images/new2.webp', tag: 'Before / After', legenda: 'Facial rejuvenation' },
  { imagemUrl: '/assets/images/new3.webp', tag: '2 weeks after Botox', legenda: 'Botox' },
  { imagemUrl: '/assets/images/new4.webp', tag: 'Before / After', legenda: 'Lip filler' },
];
  ...
  const renderResults = (rows) => {
    resultsTrack.innerHTML = rows.map(r => `
      <div class="result-card" data-lightbox="${r.imagemUrl}">
        ...
        <img loading="lazy" src="${r.imagemUrl}" alt="${r.legenda || 'Result'}">
